...
public class CheckFrame extends JFrame {
	...
	public CheckFrame() {
        ...
        // 查閱
		PayJButton = new JButton(new ImageIcon("image/Pay.PNG"));
		PayJButton.setBounds(310, 630, 133, 42);
		PayJButton.setBorderPainted(false);
        panel.add(PayJButton);
        panel.setLayer(PayJButton, new Integer(300));
