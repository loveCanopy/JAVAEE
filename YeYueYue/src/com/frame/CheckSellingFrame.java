...
public class CheckSellingFrame extends JFrame {
	...
	public CheckSellingFrame() {
		...
		// 甜品編號
		DessertIDJLabel = new JLabel("甜品編號：");
		DessertIDJLabel.setFont(new Font("宋体", Font.PLAIN, 15));
	...
	private void displaytable() {
		...
		if (buyinglist.size() == 0) {
			JOptionPane.showMessageDialog(this, "甜品編號錯誤，請重新輸入正確的編號。", "",JOptionPane.WARNING_MESSAGE);
			return;
		} else {
